...
Note that because this column name has a space in it, we had to write it surrounded by backticks, for R to understand that we are referring to a known column name.  
