...
The function `age_categories()` from {epikit} can be used within `mutate()` to define a new column `age_cat10` with 10-year age categories.  
...
**Try adding this command to the pipe chain** To see if the code is correct, compare the values in `age_years` and `age_cat10`.  
