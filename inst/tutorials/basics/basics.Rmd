...
Voila! Does your RStudio screen look different? It should not look very different. See if the upper-right corner of RStudio now shows that you are in your "intro_course" RStudio project.  
...
Currently, the script is not saved. Click the save icon above the script, or click *File -> Save As*. Name the script as "demo.R" and ensure it saves in the same folder as your R project.  
