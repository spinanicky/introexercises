...
**Close RStudio and open your File Explorer.** Navigate to the "intro_course" folder that you saved on your desktop, where you saved the R project.  
...
```{r, eval = TRUE, echo = FALSE, out.width = "75%"}
knitr::include_graphics("images/README_images/new_r_project.png")
```
