---
title: "APPLIED EPI: R Setup, syntax, and import"
output: 
  learnr::tutorial:
    progressive: true
    allow_skip: true
...
learnr::tutorial_options(exercise.eval = FALSE)  # pre-evaluate exercises
...
linelist_raw <- rio::import(system.file("dat/linelist_raw.xlsx", package = "introexercises"))
linelist <- rio::import(system.file("dat/linelist_cleaned.rds", package = "introexercises"))
```
