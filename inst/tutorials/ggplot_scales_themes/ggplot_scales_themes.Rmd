...
```{r manual-color, echo=T, warning=F, message=F}
ggplot(
  data = surv,
  mapping = aes(
    x = age_years,
...
```{r axis-end, echo=T, warning=F, message=F}
ggplot(
  data = surv,
  mapping = aes(
    x = district,
...
```{r expand-solution, echo=T, warning=F, message=F}
ggplot(
  data = surv,
  mapping = aes(
    x = district,
...
```{r flip-axes, echo=T, eval= TRUE, warning=F, message=F}
ggplot(
  data = surv,
  mapping = aes(
    x = district,
...
`r fontawesome::fa("bookmark", fill = "orange")` Which one do you prefer? Bookmark and save it for later!  
