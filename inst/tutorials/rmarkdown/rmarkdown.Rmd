...
Now try this one, and use it instead. It explicity adds a logical criteria that keeps rows that have missing `date_report`.  
...
`Give it a try, and check the hint/solution below before running the command.  
