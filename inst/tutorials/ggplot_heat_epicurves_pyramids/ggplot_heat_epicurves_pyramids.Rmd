...
```{r, eval = F, echo = T}
wmonth_break <- seq.Date(from = floor_date(min(linelist$date_onset, na.rm = T), "month"),      #Here we use min to find the lowest value, and then floor_date() from the lubridate package in order to get the 1st of the month
